...
<div class=" input-group  input-group-sm fl-lf  col-lg-3 pd-lf-5 col-sm-11 col-md-5 col-xs-11   mg-bt-3">
<input type="text" name="filtro_vendedor" id="filtro_vendedor" class="form-control" placeholder="Vendedor (Nome ou documento)" >
</div> 

<div class=" input-group  input-group-sm fl-lf  col-lg-3 pd-lf-5 col-sm-11 col-md-5 col-xs-11   mg-bt-3">
<input type="text" name="filtro_comprador" id="filtro_comprador" class="form-control" placeholder="Comprador (Nome ou documento)" >
</div> 
