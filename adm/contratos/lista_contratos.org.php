...
function carregar_totais() {
    ...
    $.getJSON('<?php echo $link . "/repositories/contratos/contratos.ctrl.php?acao=listar_totais"; ?>', {
        ...
        $('#linha_totais').html('Encontrados ' + j + ' contratos');
        total_results = j;
    });
        ...
        function(j) {
            ...
            for (var i = 0; i < j.length; i++) {
                ...
                if (j[i].status != 'excluido'){
                    ...
                    if (((<?php echo $_SESSION['perfil_id']; ?> == 1) || "<?php echo $_SESSION['supervisor']; ?>" == "S") && (j[i].status == "confirmado" || j[i].status == "pendente")) {
                        ...
                        } else if (((<?php echo $_SESSION['perfil_id']; ?> == 1)) && (j[i].status == "confirmado" || j[i].status == "pendente")) {
