...
function gerar_arquivo_remessa() {
    ...
    if ($.isNumeric(contrato_id)) {
		var GARX = "/inc/boleto/processadores/GARU/gerar_arquivo.php?acao=Z2VyYXJfYXJxdWl2bw==";
		if (contrato_id < 12460) {
			GARX = "/inc/boleto/processadores/GARB/gerar_arquivo.php?acao=Z2VyYXJfYXJxdWl2bw==";
		} 
