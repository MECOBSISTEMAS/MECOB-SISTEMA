          ...
          <div class="row">
            <div class="col-md-12">
              <div class=" menu_view_pessoa ">
				...
				<?php if(in_array($ck_mksist_permissao['perfil_id'], array('1', '3', '4'))) { ?>
					<li  class="profileted profile_menutab"><a onclick="active_menutab('profileted');" >TED</a></li>
				<?php }; ?>

				<!-- <li  class="profiletutoriais profile_menutab pull-right"><a onclick="active_menutab('profiletutoriais');" >Tutoriais</a></li> -->
				<li  class="profiletutoriais profile_menutab"><a onclick="active_menutab('profiletutoriais');" >Tutoriais</a></li>
              ...
              <div class="quadros_view_pessoa row ">
                ...
                <div id="profiletutoriais" class="profilebox col-md-12 hidden">
                  <div id="generalTabContent" class="tab-content">
                    <div id="tab-edit" class="tab-pane fade in active">
                      <?php include($raiz.'/adm/pessoas/view_pessoas_tutoriais.php');?>
                    </div>
                  </div>
                </div> 
