          <div class="row mbl pd-15">
            ...
            <div class="detalhe_fluxo " style="display:none;" >
              ...
              ?>
                    ...
                    <h3>Fluxo de caixa </h3>
					  ...
					  $percent_receber = ($total_proximos > 0) ? $soma_cred*100/$total_proximos : 0;
					  $percent_pagar = ($total_proximos > 0) ? $soma_debt*100/$total_proximos : 0;
					  ?>
            	</div>
            </div>
            ...
            <div class="row">
                    ...
                    <!-- Grafico oculto com a classe hidden comentar gera erro no componento gráfico-->
