            ...
            <div class="page-content">
                <div id="tab-general">
                    ...
                    <div id="sum_box" class="row mbl">
                        ...
                        $qtd_ad_inad = number_format($qtd_ad_inad,2,',','.');
                        $val_ad_inad = number_format($val_ad_inad,2,',','.');
                        $val_ad_in_custodia = number_format($val_ad_in_custodia,2,',','.');
                        $qtd_ad_in_custodia = number_format($qtd_ad_in_custodia,2,',','.');
                        $qtd_ad_in_custodia_pc = number_format($qtd_ad_in_custodia_pc,2,',','.');
                        $val_ad_inad_tt = number_format($val_ad_inad_tt,2,',','.');
                        $qtd_ad_inad_tt = number_format($qtd_ad_inad_tt,2,',','.');
