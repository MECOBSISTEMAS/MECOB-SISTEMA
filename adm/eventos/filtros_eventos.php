...
<?php echo combo_tipo_evento('filtro_tipo', 'filtro_tipo', 'form-control  ', '', 'Tipo');?> 
</div> 

<div class=" input-group  input-group-sm fl-lf  col-lg-2 pd-lf-5 col-sm-11 col-md-2 col-xs-11   mg-bt-3">
<input type="text" name="filtro_data" id="filtro_data"    class="form-control " placeholder="Data do evento" >
</div> 

<div class=" input-group  input-group-sm fl-lf  col-lg-4 pd-lf-5 col-sm-11 col-md-5 col-xs-11   mg-bt-3">
<input type="text" name="filtro_eventos" id="filtro_eventos"    class="form-control " placeholder="Nome do Evento" >
</div> 
