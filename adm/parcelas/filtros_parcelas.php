...
?>>
	...
	echo 'selected="selected"'; $ini_filtro=1;
                ...
                <!-- Solicitado que não mostrassem essas opções para os cliente -->
                <?php 
                    if (isset($_SESSION['perfil_id']) && !empty($_SESSION['perfil_id']) ) { 
                ?>
...
">
        ...
        <div class=" fl-lf col-lg-2  col-sm-11 col-md-2 col-xs-11  mg-bt-3 pd-0-0-0-5">
            ...
            <button type="button" class="btn btn-success btn-sm mg-lf-3 fl-lf
                <?php if($ehCliente){  echo 'hidden'; }  ?> "
                onclick="gerar_planilha_parcelas()"  rel="tooltip" data-placement="bottom" data-html="true" data-original-title="Gerar Planilha" >
