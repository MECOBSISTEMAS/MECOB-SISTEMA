...
$sub_menu_active="saldo_cliente";	
$tit_pagina = "Saldo Cliente";	
$tit_lista = " Saldo dos cliente em um determinado intervalo";		
				...
				<div id="tab-general">
					<div class="row mbl">
						<div class="col-lg-12">
							...
							<!-- input states -->
							<div class="box-body">
							<form class="form" method="POST" action="saldo_cliente/gerar" enctype="multipart/form-data" 
								...
								<div class="row">
									<label><h4>Informe o status do contrato</h4></label>
								</div>
								<!-- <div class=" input-group  input-group-sm fl-lf  col-lg-4 pd-lf-5 col-sm-11 col-md-5 col-xs-11 mg-bt-5"> -->
								<div class="input-group fl-lf  col-lg-4 pd-lf-5 col-sm-11 col-md-5 col-xs-11 mg-bt-5">
								<select name="filtro_status[]" id="filtro_status[]" class="form-control" multiple required size="6">
