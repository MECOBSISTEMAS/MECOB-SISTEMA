...
$sub_menu_active="rpt_baixas";	
$tit_pagina = "Baixas de boletos";	
$tit_lista = " Boletos baixados na data informada";		
				...
				<div id="tab-general">
					<div class="row mbl">
						<div class="col-lg-12">
							...
							<!-- input states -->
							<div class="box-body">
							<form class="form" method="POST" action="rpt_baixas/gerar" enctype="multipart/form-data" 
