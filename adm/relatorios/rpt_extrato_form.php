...
$sub_menu_active="rpt_extrato";	
$tit_pagina = "Extrato do retorno do banco";	
$tit_lista = " Extrato do retorno do banco na data informada";		
				...
				<div id="tab-general">
					<div class="row mbl">
						<div class="col-lg-12">
							...
							<!-- input states -->
							<div class="box-body">
							<form class="form" method="POST" action="rpt_extrato/gerar" enctype="multipart/form-data" 
									onsubmit="this.submit(); this.reset(); return false;">
								<div class="row">
									<label><h4>Informe a data para o relatório</h4></label>
									<div class="form-group col-lg-12">
										<div class=" input-group  input-group-sm fl-lf col-lg-2 pd-lf-5 col-sm-11 col-md-5 col-xs-11 mg-bt-3">
											<input type="text" name="filtro_data" id="filtro_data" class="form-control" placeholder="Data" required >
										</div> 
									</div>
								</div>
