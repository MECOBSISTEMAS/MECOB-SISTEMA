...
class HeaderLabel extends Funcoes implements IFuncoes {
	...
	public function montar_linha() {
		...
		//motando linha do cabe�alho da remessa
			...
			// syslog( 158, 'MECOB - ' . date('H:i:s') . ' - Arquivos Remessa linha ' . $linha);
