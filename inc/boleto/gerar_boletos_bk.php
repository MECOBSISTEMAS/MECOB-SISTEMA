...
// prepara construcao de todos os boleto em um unico pdf
try
{
	$html2pdfall = new HTML2PDF('P','A4','fr', array(0, 0, 0, 0));
	/* Abre a tela de impressão */
	//$html2pdf->pdf->IncludeJS("print(true);");
	
	$html2pdfall->pdf->SetDisplayMode('real');
	
	/* Parametro vuehtml = true desabilita o pdf para desenvolvimento do layout */
	$html2pdfall->writeHTML($content_all, isset($_GET['vuehtml']));
	...
	$html2pdfall->Output($novo_arquivo, 'F');
	$arquivos_criados[] = $novo_arquivo;
	$control_files++;
