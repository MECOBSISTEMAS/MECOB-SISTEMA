...
if(isset($_POST["email"])){
  ...
  if($email != "")
    {
      $sql_mail = "SELECT email FROM usuarios WHERE email = '$email'";
      ...
      if ($num_mail == 1) 
	{
	  ...
	  $titulo = "Atendimento MedJet";
	  	...
	  	include "newpasscontent_adm.php"; 
		$email_dest = $email ;	
		$nome_dest = $nome;
		$filename = random_str(64).".php";
		$eh = md5($email);	
		$assunto = "Recuperar Senha ADM";
      ...
      <div class="row-fluid">
        ...
        <div class="span12">
				<div id="cont" style="margin-top:-50px;">
                       ...
                       <form action="envsenha_adm.php" method="post" class="form-horizontal login barra-v" id="cadastrado">
