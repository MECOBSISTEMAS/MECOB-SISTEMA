...
$layout_title = "Condominio Fácil - 404";
                ...
                <div class="page-content">
                    <div id="tab-general">
                        <div class="row mbl">
                            ...
                            <div style="font-size:100px; font-weight:bold">404</div>
                            <h1>Página não encontrada</h1>
                            
                            
                            <div>
                            <i  style="font-size:100px; font-weight:bold; line-height:180px" class="fa fa-exclamation-triangle"></i>
                            </div>
