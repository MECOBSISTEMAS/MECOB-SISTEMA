...
class contratosDB{
                ...
                //			if(!empty($filtros["filtro_lote"])){
                    ...
                    function remover_contratos(&$conexao_BD_1, $contratos_id){
                        ...
                        function inserir_documento($contrato_id,  $descricao,$arquivo,  &$conexao_BD_1){
                            ...
                            function dados_boleto_cancelar(&$conexao_BD_1, $contrato_id, $parcela_id = ''){
                                $where_parcela = '';
                                if ($parcela_id != '') {
                                    $where_parcela = " cp.id = $parcela_id and ";
                                }
    ...
    function lista_contratos_boletos_avulsos(&$conexao_BD_1,  $filtros = "" , $order = "" , $inicial = 0,$limit=30,$ocorrencia=0){
