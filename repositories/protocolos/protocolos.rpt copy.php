...
// syslog( 158, 'MECOB - ' . date('H:i:s') . ' - PDF chamou id '.$_GET['protocolo_id']);
...
$permanencia = format_interval($first_date->diff($atual_date));
...
if($p_setor != null) {
	$html_setor = '	
					<tr>
						<td width="30%" style="text-align: right;">Setor atual: </td>
						<td style="text-align: left;">Confirmação</td>
					</tr>

					<tr>
						<td width="30%" style="text-align: right;">Data da troca de Setor: </td>
						<td style="text-align: left;">'.$dt_setor.'</td>
					</tr>
					<tr>
						<td width="30%" style="text-align: right;">Responsável pela troca: </td>
						<td style="text-align: left;">'.$p_setor.'</td>
					</tr>
					<tr>
						<td width="30%" style="text-align: right;">Permanência: </td>
						<td style="text-align: left;">'.$setor_permanencia.'</td>
					</tr>
				';
}

if($p_finalizado != null) {
	$html_finalizado = '	
					<tr>
						<td width="30%" style="text-align: right;">Data da troca de Setor: </td>
					...
					<tr>
						<td width="30%" style="text-align: right;">Permanencia no Setor anterior: </td>
						<td style="text-align: left;">'.$finalizado_permanencia.'</td>
					</tr>
					<tr>
						<td width="30%" style="text-align: right;">Tempo total protocolo: </td>
